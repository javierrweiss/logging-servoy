...
# LABEL org.opencontainers.image.authors="nospam+dockerfile@sanatoriocolegiales.net.clojars.sanatoriocolegiales"
# LABEL net.clojars.sanatoriocolegiales.sanatoriocolegiales.logging-servoy="sanatoriocolegiales logging-servoy service"
# LABEL io.github.practicalli.team="Practicalli Engineering Team"
# LABEL version="0.1.0-SNAPSHOT"
# LABEL description="sanatoriocolegiales logging-servoy service"
...
WORKDIR /service
COPY --from=builder /build/target/sanatoriocolegiales-logging-servoy-standalone.jar /service/
...
CMD ["java", "-jar", "/service/sanatoriocolegiales-logging-servoy-standalone.jar"]
